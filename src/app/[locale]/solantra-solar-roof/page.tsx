...
export default function SolarRoofPage() {
  ...
  const DOCS: Doc[] = [
    ...
    {
      title: t("docs.title2"),
      description: t("docs.text2"),
      href: "/documents/solantra-paigaldusjuhend.pdf",
      fileType: "PDF",
      fileSize: "3.2 MB",
    },
    {
  ...
  return (
    <main className="hero">
      ...
      <Container>
        <div className="grid grid-cols-3 divide-x divide-slate-200 border-b border-slate-200 py-8 select-none">
            ...
            {DOCS.map((doc) => (
              <li key={doc.title}>
                <Link
                  ...
                  className="group -mx-4 flex items-center gap-5 rounded-lg px-4 py-6 transition hover:bg-slate-50 sm:-mx-6 sm:gap-8 sm:px-6"
                >
                  <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-slate-200 text-[11px] font-bold uppercase tracking-wide text-slate-500 transition group-hover:border-blue-600 group-hover:text-blue-600">
                    {doc.fileType}
                  </span>
                  ...
                  <span
                    aria-hidden
                    className="flex shrink-0 items-center gap-1 text-sm font-semibold text-slate-400 transition group-hover:gap-2 group-hover:text-blue-600"
                  >
      ...
      <Container>
        <div className="flex flex-col justify-between gap-6 border-t border-slate-200 py-16 sm:flex-row sm:items-end sm:py-20">
          ...
          <Link
            href={contactHref}
            className="inline-flex shrink-0 items-center gap-2 text-sm font-semibold text-blue-600 transition hover:gap-3 select-none"
          >
            {t("ctaBtn")}
